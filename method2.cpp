...
//selecting points on the console
...
// warping and cropping the frame acc. to homography
...
int main(int argc, char *argv[])
{
    ...
    //Finding the cropped empty frame and reducing it's size
